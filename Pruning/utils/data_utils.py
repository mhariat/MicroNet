...
def get_dataloader(batch_size, batch_size_pruning, num_workers):
    ...
    train_dataloader_pruning = torch.utils.data.DataLoader(train_data_set, batch_size=batch_size_pruning, shuffle=True,
    ...
    val_dataloader = torch.utils.data.DataLoader(val_data_set, batch_size=batch_size, shuffle=True,
                                                 num_workers=num_workers)
    return [train_dataloader_pruning, train_dataloader, val_dataloader]
